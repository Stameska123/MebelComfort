...
?>
		...
		<footer id="colophon" class="site-footer border-top">
			<?php if (get_theme_mod('digital_storefront_show_hide_footer', true)) {?>
						        ...
						        <div class="site-info col-lg-7 col-md-7 col-12 align-self-lg-center">
						            <div class="footer-menu-left">
						            	<?php if(! get_theme_mod('digital_storefront_footer_text_setting') != ''){ ?>
										    ...
										    <span>
										    	<a target="_blank" href="<?php echo esc_url( __( 'https://www.themagnifico.net/products/free-storefront-wordpress-theme', 'digital-storefront' ) ); ?>">
									           	<?php
