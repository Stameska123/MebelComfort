...
if ( ! defined( 'DIGITAL_STOREFRONT_URL' ) ) {
    define( 'DIGITAL_STOREFRONT_URL', esc_url( 'https://www.themagnifico.net/products/retailer-wordpress-theme', 'supermarket-zone') );
}
...
if ( ! defined( 'DIGITAL_STOREFRONT_LINK' ) ) {
    define( 'DIGITAL_STOREFRONT_LINK', esc_url( 'https://www.themagnifico.net/products/retailer-wordpress-theme', 'supermarket-zone') );
}
...
function supermarket_zone_enqueue_styles() {
    ...
    wp_add_inline_style( 'supermarket-zone-style',$digital_storefront_theme_css );
...
define('DIGITAL_STOREFRONT_LIVE_DEMO',__('https://demo.themagnifico.net/supermarket-zone/','supermarket-zone'));
}
if ( ! defined( 'DIGITAL_STOREFRONT_GET_PREMIUM_PRO' ) ) {
define('DIGITAL_STOREFRONT_GET_PREMIUM_PRO',__('https://www.themagnifico.net/products/retailer-wordpress-theme','supermarket-zone'));
}
if ( ! defined( 'DIGITAL_STOREFRONT_PRO_DOC' ) ) {
define('DIGITAL_STOREFRONT_PRO_DOC',__('https://demo.themagnifico.net/eard/wathiqa/supermarket-zone-pro-doc/','supermarket-zone'));
}
if ( ! defined( 'DIGITAL_STOREFRONT_FREE_DOC' ) ) {
define('DIGITAL_STOREFRONT_FREE_DOC',__('https://demo.themagnifico.net/eard/wathiqa/supermarket-zone-free-doc/','supermarket-zone'));
}
...
function supermarket_zone_theme_color() {
    ...
    span.cart-value, .sidebar h5, .comment-respond input#submit, #button, .sidebar input[type="submit"], .sidebar button[type="submit"], #colophon, .post-navigation .nav-previous a:hover, .post-navigation .nav-next a:hover, .posts-navigation .nav-previous a:hover, .posts-navigation .nav-next a:hover, .wp-block-button__link, .about-inner-box a, .pro-button a, .woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce .woocommerce-ordering select, .woocommerce-account .woocommerce-MyAccount-navigation ul li, .btn-primary, #top-slider button.owl-next:hover, #top-slider button.owl-prev:hover, .toggle-nav i, .sidebar .tagcloud a:hover, .main-navigation ul.sub-menu > li > a:hover, .main-navigation ul.sub-menu > li > a:focus{
     ...
     a, .social-link i:hover, .article-box a, p.price, .woocommerce ul.products li.product .price, .woocommerce div.product p.price, .woocommerce div.product span.price, .woocommerce-message::before, .woocommerce-info::before, .sidebar ul li a:hover, .widget a:hover, .widget a:focus, .main-navigation .menu > li > a:hover, #site-navigation .menu ul li a:hover, .product-asset i:hover{
...
function supermarket_zone_remove_customize_register() {
    ...
    // $wp_customize->remove_setting( 'digital_storefront_preloader_bg_color' );
    // $wp_customize->remove_control( 'digital_storefront_preloader_bg_color' );
}
