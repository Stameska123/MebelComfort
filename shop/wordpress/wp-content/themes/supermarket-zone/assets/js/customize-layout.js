...
(function( $ ) {
	...
	*/
		...
		function digital_storefront_customizer_label( id, title ) {
			...
			if ( id === 'digital_storefront_preloader_hide' || id === 'digital_storefront_sticky_header' || id === 'digital_storefront_scroll_hide' || id === 'digital_storefront_products_per_row' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-digital_storefront_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'digital_storefront_show_hide_footer' || id === 'digital_storefront_show_hide_copyright') {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-digital_storefront_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
	...
	*/
		...
		digital_storefront_customizer_label( 'digital_storefront_woocommerce_product_sale', 'Woocommerce Product Sale' );
		...
		//Footer
		digital_storefront_customizer_label( 'digital_storefront_show_hide_footer', 'Footer' );
