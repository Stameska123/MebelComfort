...
<div id="category-post">
  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="page-box row">
      <?php $modern_furniture_store_post_layout = get_theme_mod( 'modern_furniture_store_post_layout','image-content');
      if($modern_furniture_store_post_layout == 'image-content'){ ?>
      ...
      <?php }
      else if($modern_furniture_store_post_layout == 'content-image'){ ?>
        <div class="box-content col-lg-6 col-md-12">
          <h4><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php the_title_attribute(); ?>"><?php the_title();?></a></h4>
          <div class="box-info">
              <?php 
